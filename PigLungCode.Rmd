...
g1=ggplot(PD, aes(SampleType, PD, color = Farm)) + stat_boxplot(fill = NA) + stat_c + theme_classic()
...
g2=ggplot(Shannon, aes(SampleType, Shannon, color = Farm)) + stat_boxplot(fill = NA) +expand_limits(y=0) + theme_classic()

grid.arrange(g1, g2, nrow = 1)

g=arrangeGrob(g1,g2,nrow=1)

ggsave(file="~/PigLungs/PublicationFigures/LungalphaDiv.PDF", g, width = 20, height = 20, units = "cm")
...
g1=ggplot(PD, aes(SampleType, PD, color = Farm)) + stat_boxplot(fill = NA) + expand_limits(y=0) + theme_classic()
...
ggsave(file="~/PigLungs/PublicationFigures/EnvalphaDiv.PDF", g, width = 20, height = 20, units = "cm")
...
ggplot() + geom_bar(aes(y = value, x = Group, fill = variable), data = STDF_avg, stat ="identity")+scale_fill_manual(values=c( "green4", "royalblue", "brown", "grey52", "deepskyblue3"))
...
g=ggplot(STDF_NCAT, aes(Group, value)) + facet_grid(. ~ variable) + stat_boxplot(fill = NA) + theme_classic()#+ geom_jitter(width = 0.2, alpha = 0.5, aes(color = Group))+scale_fill_manual(values=c( "green4", "royalblue", "brown", "grey52", "deepskyblue3"))
...
g = ggplot() + geom_bar(aes(y = value, x = Group, fill = variable), data = SLDF, stat ="identity")+scale_fill_manual(values=c( "green4", "royalblue", "brown", "grey52", "deepskyblue3", "chocolate"))

ggsave(file="~/PigLungs/PublicationFigures/STforSLAvg.PDF", g, width = 10, height = 10, units = "cm")
...
g=ggplot(SLDF, aes(variable, value)) + facet_grid(. ~ Group) + stat_boxplot(fill = NA) + ggtitle("SourceTracker") + labs(x = "Sample Type", y = "Relative Abundance")+theme_classic()
g
