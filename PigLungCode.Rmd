...
fit = aov(value ~ variable*Group, data = STDF_NCAT)
plot(fit)
...
shapiro.test(STDF_NCAT$value) #p = 1e-11

kruskal.test(value ~ variable, data = STDF_NCAT) #p<0.05

pairwise.wilcox.test(STDF_NCAT$value, STDF_NCAT$variable, p.adjust.method = "BH")
```
...
shapiro.test(STDF_FOF$value) #p = 1e-11

kruskal.test(value ~ variable, data = STDF_FOF)

pairwise.wilcox.test(STDF_FOF$value, STDF_FOF$variable, p.adjust.method = "BH")
```
